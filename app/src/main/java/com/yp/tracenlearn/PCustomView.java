...
public class PCustomView extends View {
    ...
    // To set stroke color that we get from P_Activity color panel so we pass the index into this
...
//Different accuracy messages for different situations
        if (strokeCount <= 3 && totalStrokeCoordinates > 130 && accuracy > 90) {
            return "Accuracy Score: " + accuracy + "%"; //Accurate letter, max 3 strokes to achieve P
