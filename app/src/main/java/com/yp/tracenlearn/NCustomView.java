...
public class NCustomView extends View {
    ...
    private NCustomView.NoStrokesCallback noStrokesCallback;
    private Handler handler = new Handler(); // To handle delays

    public NCustomView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    // To set stroke color that we get from N_Activity color panel so we pass the index into this
    ...
    */
    ...
    protected void onSizeChanged(int w,int h, int oldw, int oldh) {
        ...
        BitmapDrawable drawable = (BitmapDrawable) getResources().getDrawable(R.drawable.letter_n);
    ...
    public void setOnNoStrokesDetectedCallback(NCustomView.NoStrokesCallback callback) {
    ...
    */
    private String getAccuracyInfo() {
        ...
        if (strokeCount <= 4 && totalStrokeCoordinates > 140 && accuracy > 90) {
            return "Accuracy Score: " + accuracy + "%"; //Accurate letter, max 4 strokes to achieve N
