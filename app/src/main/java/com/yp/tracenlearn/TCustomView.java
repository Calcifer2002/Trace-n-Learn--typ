...
public class TCustomView extends View {
    ...
    private TCustomView.NoStrokesCallback noStrokesCallback;
    ...
    // To set stroke color that we get from T_Activity color panel, so we pass the index into this
    ...
    */
    ...
    public void setOnNoStrokesDetectedCallback(TCustomView.NoStrokesCallback callback) {
...
//Different accuracy messages for different situations
        if (strokeCount <= 3 && totalStrokeCoordinates > 120 && accuracy > 90) {
            return "Accuracy Score: " + accuracy + "%"; //Accurate letter, max 3 strokes to achieve T
