...
public class OCustomView extends View {
    ...
    // To set stroke color that we get from O_Activity color panel so we pass the index into this
    ...
    */
    private String getAccuracyInfo() {
        ...
        if (strokeCount <= 2 && totalStrokeCoordinates > 160 && accuracy > 90) {
            return "Accuracy Score: " + accuracy + "%"; //Accurate letter, max 2 strokes to achieve O
