...
public class FCustomView extends View {
    ...
    // To set stroke color that we get from F_Activity color panel so we pass the index into this
    ...
    */
    private String getAccuracyInfo() {
        ...
        if (strokeCount <= 4 && totalStrokeCoordinates > 100 && accuracy > 90) {
            return "Accuracy Score: " + accuracy + "%"; //Accurate letter, max 4 strokes to achieve F
