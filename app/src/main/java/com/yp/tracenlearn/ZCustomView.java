...
public class ZCustomView extends View {
    ...
    // To set stroke color that we get from Z_Activity color panel, so we pass the index into this
    ...
    */
    private String getAccuracyInfo() {
        ...
        if (strokeCount <= 2 && totalStrokeCoordinates > 130 && accuracy > 90) {
            return "Accuracy Score: " + accuracy + "%"; //Accurate letter, max 2 strokes to achieve Z
