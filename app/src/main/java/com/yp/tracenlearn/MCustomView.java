...
public class MCustomView extends View {
    ...
    private MCustomView.NoStrokesCallback noStrokesCallback;
    ...
    // To set stroke color that we get from M_Activity color panel so we pass the index into this
    ...
    */
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        BitmapDrawable drawable = (BitmapDrawable) getResources().getDrawable(R.drawable.letter_m);
    ...
    public void setOnNoStrokesDetectedCallback(MCustomView.NoStrokesCallback callback) {
    ...
    */
    private String getAccuracyInfo() {
        ...
        if (strokeCount <= 5 && totalStrokeCoordinates > 170 && accuracy > 90) {
            return "Accuracy Score: " + accuracy + "%"; //Accurate letter, max 5 strokes to achieve M

        } else if (strokeCount > 5) {
            return "NO: " + accuracy + "%" + "many"; //If letter is drawn with way too many strokes
        } else if (totalStrokeCoordinates < 170 && accuracy > 90) {
