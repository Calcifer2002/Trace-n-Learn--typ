                            ...
                            if (child instanceof ImageView) {
                                ...
                                child.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        customACanvas.setStrokeColor(getColorForIndex(colorIndex)); //change colour
                                    }
                                });
                            }
                        }
                ...
                customACanvas.setOnNoStrokesDetectedCallback(new ACustomView.NoStrokesCallback() {
                    ...
                    public void onNoStrokesDetected(String accuracyInfo) {
                        if (accuracyInfo.toLowerCase().contains("no")) { //my accuracy info if incorrect letter has the word no in it
                            ...
                            databaseReference.child("users").child(uid).child("a-flower").setValue(1);//we save the accuracy rate for that letter in the db
                            new Handler().postDelayed(new Runnable() {
                                @Override
                                public void run() {
