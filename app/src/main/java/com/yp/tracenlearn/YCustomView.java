...
public class YCustomView extends View {
    ...
    // To set stroke color that we get from Y_Activity color panel, so we pass the index into this
    ...
    */
    private String getAccuracyInfo() {
        ...
        if (strokeCount <= 4 && totalStrokeCoordinates > 120 && accuracy > 90) {
            return "Accuracy Score: " + accuracy + "%"; //Accurate letter, max 3 strokes to achieve Y
