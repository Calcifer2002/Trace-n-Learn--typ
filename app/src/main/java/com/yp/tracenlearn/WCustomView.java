...
public class WCustomView extends View {
    ...
    private WCustomView.NoStrokesCallback noStrokesCallback;
    private Handler handler = new Handler(); // To handle delays

    public WCustomView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    // To set stroke color that we get from W_Activity color panel, so we pass the index into this
    ...
    */
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        BitmapDrawable drawable = (BitmapDrawable) getResources().getDrawable(R.drawable.letter_w);
    ...
    public void setOnNoStrokesDetectedCallback(WCustomView.NoStrokesCallback callback) {
    ...
    */
    private String getAccuracyInfo() {
        ...
        if (strokeCount <= 5 && totalStrokeCoordinates > 140 && accuracy > 90) {
            return "Accuracy Score: " + accuracy + "%"; //Accurate letter, max 5 strokes to achieve W
