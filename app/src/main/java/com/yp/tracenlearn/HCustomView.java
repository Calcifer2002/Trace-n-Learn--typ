...
public class HCustomView extends View {
    ...
    private HCustomView.NoStrokesCallback noStrokesCallback;
    ...
    // To set stroke color that we get from H_Activity color panel so we pass the index into this
    ...
    */
    ...
    public void setOnNoStrokesDetectedCallback(HCustomView.NoStrokesCallback callback) {
    ...
    */
    private String getAccuracyInfo() {
        ...
        if (strokeCount <= 4 && totalStrokeCoordinates > 140 && accuracy > 90) {
            return "Accuracy Score: " + accuracy + "%"; //Accurate letter, max 4 strokes to achieve H
