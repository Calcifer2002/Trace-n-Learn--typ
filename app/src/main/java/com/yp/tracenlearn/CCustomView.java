...
public class CCustomView extends View {
    ...
    private CCustomView.NoStrokesCallback noStrokesCallback;
    ...
    // To set stroke color that we get from C_Activity color panel so we pass the index into this
    ...
    */
    ...
    public void setOnNoStrokesDetectedCallback(CCustomView.NoStrokesCallback callback) {
    ...
    */
    private String getAccuracyInfo() {
        ...
        if (strokeCount <= 2 && totalStrokeCoordinates > 90 && accuracy > 90) {
            return "Accuracy Score: " + accuracy + "%"; //Accurate letter, max 2 strokes to achieve C
