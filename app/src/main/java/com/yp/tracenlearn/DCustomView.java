...
public class DCustomView extends View {
    ...
    private DCustomView.NoStrokesCallback noStrokesCallback;
    ...
    // To set stroke color that we get from D_Activity color panel so we pass the index into this
    ...
    */
    ...
    public void setOnNoStrokesDetectedCallback(DCustomView.NoStrokesCallback callback) {
    ...
    */
    private String getAccuracyInfo() {
        ...
        if (strokeCount <= 3 && totalStrokeCoordinates > 120 && accuracy > 90) {
            return "Accuracy Score: " + accuracy + "%"; //Accurate letter, max 3 strokes to achieve D
