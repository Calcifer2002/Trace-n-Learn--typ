...
public class KCustomView extends View {
    ...
    private KCustomView.NoStrokesCallback noStrokesCallback;
    private Handler handler = new Handler(); // To handle delays

    public KCustomView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    // To set stroke color that we get from K_Activity color panel so we pass the index into this
    ...
    */
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        BitmapDrawable drawable = (BitmapDrawable) getResources().getDrawable(R.drawable.letter_k);
    ...
    public void setOnNoStrokesDetectedCallback(KCustomView.NoStrokesCallback callback) {
    ...
    */
    private String getAccuracyInfo() {
        ...
        if (strokeCount <= 4 && totalStrokeCoordinates > 120 && accuracy > 90) {
            return "Accuracy Score: " + accuracy + "%"; //Accurate letter, max 4 strokes to achieve K
